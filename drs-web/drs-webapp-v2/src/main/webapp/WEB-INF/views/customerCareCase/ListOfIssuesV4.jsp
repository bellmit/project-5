...
<div class="max-width">
  ...
  <div class="container-fluid" ng-app="issueList" ng-controller="issueListCtrl">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <!-- <div class="col-md-6">
          ...
          <div class="col-md-4 text-right">
            ...
            <div>
              <spring:message code='issue.dateTimeNowUtc' arguments="${dateTimeNowUtc}" />
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <table id="issue" class="table table-striped table-hover table-floated">
