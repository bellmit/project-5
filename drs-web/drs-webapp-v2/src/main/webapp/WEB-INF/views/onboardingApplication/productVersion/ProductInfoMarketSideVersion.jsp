    ...
    <div class="col-md-12 max-width" >
    	<div class="breadcrumb">
        	<sec:authorize access="hasAnyRole('${auth['PRODUCT_ONBOARDING_SUPPLIER']}')">
        		...
        		<span>${breadcrumbProduct}</span><div class="bnext"><img src="<c:url value="/resources/images/bnext.png"/>"></div>
        		<span> [<spring:message code="detailsOfBaseProduct.edit" />] <spring:message code="detailsOfBaseProduct.productInformation" /> @<spring:message code="${marketSideRegion}" /></span>
        	</sec:authorize>
...
<div class="max-width" ng-app="productInfoMarketSideVersion" ng-controller="productInfoMarketSideVersionCtrl">
	...
	<ul class="nav nav-tabs" role="tablist" style="margin-top:20px;">
        ...
        <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab"><spring:message code="detailsOfBaseProduct.productInformation" /></a></li>  
     	<li role="presentation"><a href="${pageContext.request.contextPath}/pmmi/${baseProductCode}?supplierKcode={{supplierKcode}}"  role="tab"><spring:message code="detailsOfBaseProduct.productMarketingMaterial" /></a></li>
  	</ul>	
	...
	<div class="row">		
		<div class="col-md-12">
			<table class="table table-withoutBorder" style="width:500px">
				<tr>
					<td class="text-right">
