 ...
 *             &lt;element name="TaxWithholdingEventList" type="{http://mws.amazonservices.com/Finances/2015-05-01}TaxWithholdingEvent" maxOccurs="unbounded"/&gt;
 *          &lt;/sequence&gt;
 *       &lt;/restriction&gt;
 *    &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class FinancialEvents extends AbstractMwsObject {
    ...
    private List<TaxWithholdingEvent> taxWithholdingEventList;
    ...
    /**
     * Get the value of TaxWithholdingEventList.
     *
     * @return The value of TaxWithholdingEventList.
     */
    public List<TaxWithholdingEvent> getTaxWithholdingEventList() {
        if (taxWithholdingEventList==null) {
            taxWithholdingEventList = new ArrayList<TaxWithholdingEvent>();
        }
        return taxWithholdingEventList;
    }

    /**
     * Set the value of TaxWithholdingEventList.
     *
     * @param taxWithholdingEventList
     *            The new value to set.
     */
    ...
    /**
     * Clear TaxWithholdingEventList.
     */
    public void unsetTaxWithholdingEventList() {
        this.taxWithholdingEventList = null;
    }

    /**
     * Check to see if TaxWithholdingEventList is set.
     *
     * @return true if TaxWithholdingEventList is set.
     */
    public boolean isSetTaxWithholdingEventList() {
        return taxWithholdingEventList != null && !taxWithholdingEventList.isEmpty();
    }

    /**
     * Add values for TaxWithholdingEventList, return this.
     *
     * @param taxWithholdingEventList
     *             New values to add.
     *
     * @return This instance.
     */
    public FinancialEvents withTaxWithholdingEventList(TaxWithholdingEvent... values) {
        List<TaxWithholdingEvent> list = getTaxWithholdingEventList();
        for (TaxWithholdingEvent value : values) {
            list.add(value);
        }
        return this;
    }
    ...
    public void readFragmentFrom(MwsReader r) {
        ...
        taxWithholdingEventList = r.readList("TaxWithholdingEventList", "TaxWithholdingEvent", TaxWithholdingEvent.class);
    }
    ...
    public void writeFragmentTo(MwsWriter w) {
        ...
        w.writeList("TaxWithholdingEventList", "TaxWithholdingEvent", taxWithholdingEventList);
    }
