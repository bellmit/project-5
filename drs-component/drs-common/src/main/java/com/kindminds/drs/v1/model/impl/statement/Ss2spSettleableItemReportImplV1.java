...
public class Ss2spSettleableItemReportImplV1 implements Ss2spSettleableItemReport {
	...
	public String toString() {
		return "Ss2spSettleableItemReportImplV1 [getSettleableItemName()=" + getSettleableItemName()
	...
	public String getTotal() {
		...
		int scale = this.currency.getScale();
		return total.setScale(scale, RoundingMode.HALF_UP).toString();
	}
