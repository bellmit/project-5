...
/**
 * CreateFulfillmentOrderItem complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="CreateFulfillmentOrderItem"&gt;
 *    &lt;complexContent&gt;
...
@XmlType(name="CreateFulfillmentOrderItem", propOrder={
    "sellerSKU",
...
public class CreateFulfillmentOrderItem extends AbstractMwsObject {
     ...
     * @return This instance.
     */
    public CreateFulfillmentOrderItem withQuantity(int quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "CreateFulfillmentOrderItem",this);
    }

    /** Value constructor. */
    public CreateFulfillmentOrderItem(String sellerSKU,String sellerFulfillmentOrderItemId,int quantity) {
        this.sellerSKU = sellerSKU;
        this.sellerFulfillmentOrderItemId = sellerFulfillmentOrderItemId;
        this.quantity = quantity;
    }    
