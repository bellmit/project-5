...
<script type='text/javascript' src="<c:url value="/resources/js/product/editProduct.js"/>"></script>
...
<script>
	...
	app.controller('developingProductCtrl',['$scope','$http',function($scope, $http) {
			
			$scope.lineItemFilled= false;
			// $scope.testp =  new Product();
			// console.log( $scope.testp.id)
								...
								$scope.materialLineItems = [ {material : ""} ];
								$scope.referenceLinkLineItems = [ {referenceLink : ""} ];
								...
								$scope.otherWirelessTechLineItems = [ {otherWirelessTech : ""} ];
								$scope.hazardousMaterialLineItems = [ {hazardousMaterial : ""} ];
								...
								$scope.checkAllergy = function() {
									...
									if ($('#allergyNo').is(':checked')) {
										...
										$("#allergyOther").val("");
										$("#allergyOther").prop("disabled",	true);
									...
									if ($('#allergyYesOther').is(':checked')) {
										...
										$scope.allergy = true;
										$scope.allergyName = $("#allergyOther").val();

										$("#allergyOther").prop("disabled",false);
								...
								$scope.resetIsFilled = function(){
								    $scope.lineItemFilled =false;
								}

								$scope.lineItemRequiredIsFilled = function(item){

								    if($scope.productWithVariation=='1'){
								        if(item.type1Value !=null && item.SKU !=null && item.type1Value !="" && item.SKU !="" && (item.type2 =="" || (item.type2Value != null && item.type2Value !="" ))){
                                            $scope.lineItemFilled =true;
									...
									for(var marketSideRegion in $scope.marketSideRegionList){
										...
										if($scope.marketSideRegionList.hasOwnProperty(marketSideRegion)) {
											...
											var jsonDataForMarketSide = {
													country : $scope.marketSideRegionList[marketSideRegion],
													hsCode :(productInfoMarketSideWhole.length > 0) ? productInfoMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["hsCode"] :"",
													dutyRate : (productInfoMarketSideWhole.length > 0) ? productInfoMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["dutyRate"] :"",
													note : (productInfoMarketSideWhole.length > 0) ? productInfoMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["note"] :"",
													products : angular.toJson(productLineItemsForMarketSide),
													productWithVariation : $scope.productWithVariation
											};

											var jsonDataForMarketingMaterialMarketSide = {
													name : (productMarketingMaterialMarketSideWhole.length > 0) ? productMarketingMaterialMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["name"] : "",
													shortName : (productMarketingMaterialMarketSideWhole.length > 0) ? productMarketingMaterialMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["shortName"]: "",
													feature1 : (productMarketingMaterialMarketSideWhole.length > 0) ? productMarketingMaterialMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["feature1"]: "",
													feature2 : (productMarketingMaterialMarketSideWhole.length > 0) ? productMarketingMaterialMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["feature2"]: "",
													feature3 : (productMarketingMaterialMarketSideWhole.length > 0) ? productMarketingMaterialMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["feature3"]: "",
													feature4 : (productMarketingMaterialMarketSideWhole.length > 0) ? productMarketingMaterialMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["feature4"]: "",
													feature5 :  (productMarketingMaterialMarketSideWhole.length > 0) ? productMarketingMaterialMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["feature5"]: "",
													description :(productMarketingMaterialMarketSideWhole.length > 0) ?  productMarketingMaterialMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["description"]: "",
													searchTerms1 :(productMarketingMaterialMarketSideWhole.length > 0) ? productMarketingMaterialMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["searchTerms1"]: "",
													searchTerms2 : (productMarketingMaterialMarketSideWhole.length > 0) ? productMarketingMaterialMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["searchTerms2"]: "",
													searchTerms3 : (productMarketingMaterialMarketSideWhole.length > 0) ? productMarketingMaterialMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["searchTerms3"]: "",
													searchTerms4 : (productMarketingMaterialMarketSideWhole.length > 0) ? productMarketingMaterialMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["searchTerms4"]: "",
													searchTerms5 : (productMarketingMaterialMarketSideWhole.length > 0) ? productMarketingMaterialMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["searchTerms5"]: "",
													note : (productMarketingMaterialMarketSideWhole.length > 0) ? productMarketingMaterialMarketSideWhole[$scope.marketSideRegionList[marketSideRegion]]["note"]: "",
													country : $scope.marketSideRegionList[marketSideRegion],
								...
								$scope.submitProductInfoSource = function(form){
									...
									if($scope.BaseProductCodeExisting
	...
	ng-controller="developingProductCtrl">
		...
		<div class="row rowframe">
					...
					<c:choose>
								...
								<!--
								<select class="form-control" name="supplierKcode" ng-model="supplierKcode" ng-change="getDRSBaseProductCode()"
								ng-disabled="operatorType=='Edit'" required>
							...
							<c:choose>
								<c:when test="${type eq 'Create'}">
								 ...
								 <button id="reset" type="button"
									class="btn btn-default ml-1" ng-click="resetProduct(); resetIsFilled()"><spring:message code="productInfoSourceVersion.resetVariationProduct" /></button>
								</c:when>
								</c:choose>
			...
			<div class="form-row my-3" ng-repeat="productLineItem in productLineItems" >
				<div class= "col" ng-if="productWithVariation=='1'&&type1!=''">
					...
					<input class="form-control" name="type1Value{{$id}}" ng-model="productLineItem.type1Value" ng-disabled="productLineItem.status=='edit' && formValidated == true" ng-change="lineItemRequiredIsFilled(productLineItem)" required>
				...
				<div class="col" ng-if="productWithVariation=='1'&&type2!=''">
					...
					<input class="form-control" name="type2Value{{$id}}" ng-model="productLineItem.type2Value" ng-disabled="productLineItem.status=='edit' && formValidated == true" ng-change="lineItemRequiredIsFilled(productLineItem)" required>
				...
				<dic class="col">
					...
					<input class="form-control" name="SKU{{$id}}" ng-model="productLineItem.SKU" ng-change="checkSKUValueDuplicated(productLineItem); lineItemRequiredIsFilled(productLineItem);" ng-disabled="productLineItem.status=='edit' && formValidated == true" ng-pattern="/^[a-zA-Z0-9\-]+$/" required>
...
<!-- SKU Dimensions -->
        ...
        <div class="row rowframe">
			...
			<div id="noteRow" class="row">
				<div class="col-md-12">
				<textarea id="note" class="form-control" rows="10" ng-model="note">
				${comment}
				</textarea>
				</div>
			<script type="text/javascript">
			...
			<div id="innerNoteRow" class="row">
				<div class="col-md-12">
				<textarea id="innerNote" class="form-control" rows="10" ng-model="innerNote">
                ${internalComment}
				</textarea>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12 text-right">
					...
					<c:choose>
						...
						ng-disabled="productNameEnglish == null || supplierBaseProductCode == null || !lineItemFilled"
						value="<spring:message code="productInfoSourceVersion.submit" />" />
						</c:when>
						<c:otherwise>
						<a class="btn btn-success" href="${pageContext.request.contextPath}/CoreProductInformation/${baseProductCode}"><spring:message code="detailsOfBaseProduct.back" /></a>
