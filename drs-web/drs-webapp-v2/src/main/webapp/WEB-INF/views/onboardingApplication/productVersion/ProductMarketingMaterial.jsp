...
<form>	
	...
	<div class="row">
		<div class="col-md-12">
			<h3 class="form-title"><spring:message code="productMarketingMaterial.variationProductName" /></h3>
		</div>
	</div>	
	<div class="row">
		<div class="col-md-12">
			<table class="table table-withoutBorder">
				...
				<tr>
					<td>
						<input id="productName" class="form-control" style="width: 820px; 
						display: inline;" ng-model="productName">
						</br>
						<span><spring:message code="productMarketingMaterial.50Title" /></span>	
					</td>
				</tr>
				...
				<c:if test="${type ne 'source'}">
					...
					<tr>
						<td>
							<h5 id="shortNameTitle"><spring:message code="productMarketingMaterial.productShortName" /></h5>
							
							<input id="productShortName" class="form-control" style="width: 820px; 
							display: inline;" ng-model="productShortName">
							</br>
							<span><spring:message code="productMarketingMaterial.50Title" /></span>	
						</td>												
					</tr>
		...
		<div class="col-md-12">
			<table class="table table-withoutBorder">
				<tr>
					...
					<td>
						<input id="feature1" class="form-control" style="width: 800px; display: inline;" ng-model="feature1">
						<span id="wordCounterForFeature1"></span>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input id="feature2" class="form-control" style="width: 800px; display: inline;" ng-model="feature2">
						<span id="wordCounterForFeature2"></span>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input id="feature3" class="form-control" style="width: 800px; display: inline;" ng-model="feature3">
						<span id="wordCounterForFeature3"></span>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input id="feature4" class="form-control" style="width: 800px; display: inline;" ng-model="feature4">
						<span id="wordCounterForFeature4"></span>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input id="feature5" class="form-control" style="width: 800px; display: inline;" ng-model="feature5">
						<span id="wordCounterForFeature5"></span>
					</td>
				</tr>			
			</table>
		</div>
	...
	<div id="descriptionRow" class="row">
		<div class="col-md-12">
			<textarea id="description" class="form-control" style="height:400px;" ng-model="description"></textarea>
		...
		<div class="col-md-12">
			<table class="table table-withoutBorder">
				<tr>
					...
					<td>
						<input id="searchTerms1" class="form-control" style="width: 800px; display: inline;" ng-model="searchTerms1">
						<span id="wordCounterForSearchTerms1"></span>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input id="searchTerms2" class="form-control" style="width: 800px; display: inline;" ng-model="searchTerms2">
						<span id="wordCounterForSearchTerms2"></span>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input id="searchTerms3" class="form-control" style="width: 800px; display: inline;" ng-model="searchTerms3">
						<span id="wordCounterForSearchTerms3"></span>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input id="searchTerms4" class="form-control" style="width: 800px; display: inline;" ng-model="searchTerms4">
						<span id="wordCounterForSearchTerms4"></span>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input id="searchTerms5" class="form-control" style="width: 800px; display: inline;" ng-model="searchTerms5">
						<span id="wordCounterForSearchTerms5"></span>
					</td>
				</tr>			
			</table>
		</div>
...
$('#descriptionRow .wysihtml5-sandbox').load(function(e){	
	$('#descriptionRow .wysihtml5-sandbox').contents().find('body').on("change keyup paste blur click",function() {
		var descriptionContent =  $("#descriptionRow .wysihtml5-sandbox").contents().find('body').html().replace(/\⁺/g,'&#8314;');	
		if(descriptionContent.length == 1){ 			  
			$("#wordCounterForDescription").html(descriptionContent.length +" character"); 
