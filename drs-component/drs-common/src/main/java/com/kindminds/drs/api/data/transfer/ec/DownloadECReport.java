...
public final class DownloadECReport implements AutoProcessECReport {
    ...
    public DownloadECReport( Integer marketPlaceId, LocalDate scheduledDate, Integer reportType, Boolean success) {
    ...
    public final DownloadECReport copy( Integer marketPlaceId, LocalDate scheduledDate, Integer reportType, Boolean success) {
        return new DownloadECReport(marketPlaceId, scheduledDate, reportType, success);
    }

    // $FF: synthetic method
    public static DownloadECReport copy$default(DownloadECReport var0, Integer var1, LocalDate var2, Integer var3, Boolean var4, int var5, Object var6) {
        if ((var5 & 1) != 0) {
    ...
    public String toString() {
        return "DownloadECReport(marketPlaceId=" + this.getMarketPlaceId() + ", scheduledDate=" + this.getScheduledDate() + ", reportType=" + this.getReportType() + ", success=" + this.getSuccess() + ")";
    }
    ...
    public boolean equals( Object var1) {
        if (this != var1) {
            if (var1 instanceof DownloadECReport) {
                DownloadECReport var2 = (DownloadECReport)var1;
                /*
