...
public final class ValidateECReport implements AutoProcessECReport {
    ...
    public ValidateECReport( Integer marketPlaceId, LocalDate scheduledDate, Integer reportType, Boolean success) {
    ...
    public final ValidateECReport copy( Integer marketPlaceId, LocalDate scheduledDate, Integer reportType, Boolean success) {
        return new ValidateECReport(marketPlaceId, scheduledDate, reportType, success);
    }

    // $FF: synthetic method
    public static ValidateECReport copy$default(ValidateECReport var0, Integer var1, LocalDate var2, Integer var3, Boolean var4, int var5, Object var6) {
        if ((var5 & 1) != 0) {
    ...
    public String toString() {
        return "ValidateECReport(marketPlaceId=" + this.getMarketPlaceId() + ", scheduledDate=" + this.getScheduledDate() + ", reportType=" + this.getReportType() + ", success=" + this.getSuccess() + ")";
    }
    ...
    public boolean equals( Object var1) {
        if (this != var1) {
            if (var1 instanceof ValidateECReport) {
                ValidateECReport var2 = (ValidateECReport)var1;
                /*
