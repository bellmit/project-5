...
/**
 * CancelFulfillmentOrderRequest complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="CancelFulfillmentOrderRequest"&gt;
 *    &lt;complexContent&gt;
...
@XmlType(name="CancelFulfillmentOrderRequest", propOrder={
    "sellerId",
    "mwsAuthToken",
    "marketplace",
    "sellerFulfillmentOrderId"
})
@XmlRootElement(name = "CancelFulfillmentOrderRequest")
public class CancelFulfillmentOrderRequest extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/FulfillmentOutboundShipment/2010-10-01/", "CancelFulfillmentOrderRequest",this);
    }

    /** Value constructor. */
    public CancelFulfillmentOrderRequest(String sellerId,String sellerFulfillmentOrderId) {
        this.sellerId = sellerId;
        this.sellerFulfillmentOrderId = sellerFulfillmentOrderId;
    }    
