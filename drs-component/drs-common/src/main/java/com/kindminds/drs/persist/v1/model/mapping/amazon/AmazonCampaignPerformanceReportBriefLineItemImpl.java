...
public class AmazonCampaignPerformanceReportBriefLineItemImpl implements AmazonCampaignPerformanceReportBriefLineItem {
	...
	public AmazonCampaignPerformanceReportBriefLineItemImpl() {

	}

	public AmazonCampaignPerformanceReportBriefLineItemImpl(Integer id, String campaignName, String adGroupName, String advertisedSku, String keyword, String matchType, String startDate, String endDate, Integer clicks) {
		this.id = id;
	...
	public String toString() {
		return "AmazonCampaignPerformanceReportBriefLineItemImpl [getCampaignName()=" + getCampaignName()
