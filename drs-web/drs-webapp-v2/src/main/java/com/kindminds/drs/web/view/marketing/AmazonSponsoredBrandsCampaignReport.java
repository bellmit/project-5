...
public class AmazonSponsoredBrandsCampaignReport implements Serializable{
	...
	private List<AmazonHeadlineSearchAdReportItem> lineItems = null;
				
	@Override
	public String toString() {
		return "AmazonSponsoredBrandsCampaignReport [getTotalImpressions()=" + getTotalImpressions()
				...
				+ getCurrency() + ", getAmazonHeadlineSearchAdReportItems()=" + getAmazonHeadlineSearchAdReportItems()
				+ "]";
	}
	...
	public void setAmazonHeadlineSearchAdReportItems(List<AmazonHeadlineSearchAdReportItem> lineItems){
