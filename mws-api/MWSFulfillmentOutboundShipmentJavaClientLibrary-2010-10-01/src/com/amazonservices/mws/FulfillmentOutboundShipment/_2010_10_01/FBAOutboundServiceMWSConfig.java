...
public class FBAOutboundServiceMWSConfig {
    ...
    static final String DEFAULT_SERVICE_PATH = "FulfillmentOutboundShipment/2010-10-01";
    ...
    public FBAOutboundServiceMWSConfig withMaxConnections(int maxConnections) {
        cc.setMaxConnections(maxConnections);
        return this;
    }
    ...
    public FBAOutboundServiceMWSConfig withServiceURL(String aserviceUrl) {
    ...
    public FBAOutboundServiceMWSConfig withMaxAsyncQueueSize(int size) {
        cc.setMaxAsyncQueueSize(size);
        return this;
    }
    ...
    public FBAOutboundServiceMWSConfig withMaxAsyncThreads(int threads) {
        cc.setMaxAsyncThreads(threads);
        return this;
    }
