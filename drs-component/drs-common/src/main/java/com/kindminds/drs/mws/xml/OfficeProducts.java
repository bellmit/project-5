...
public class OfficeProducts {
    ...
    @XmlElement(name = "RulingType")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    @XmlSchemaType(name = "normalizedString")
    protected String rulingType;
    ...
    protected CapacityUnit capacity;
     ...
     *     
     */
    public void setRulingType(String value) {
     ...
     *     
     */
    public CapacityUnit getCapacity() {
        return capacity;
    }
     ...
     *     
     */
    public void setCapacity(CapacityUnit value) {
        this.capacity = value;
    }
