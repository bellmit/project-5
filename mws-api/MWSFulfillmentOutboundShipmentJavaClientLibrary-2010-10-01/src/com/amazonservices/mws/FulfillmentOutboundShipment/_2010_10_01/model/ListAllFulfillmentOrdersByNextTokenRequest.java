...
public class ListAllFulfillmentOrdersByNextTokenRequest extends AbstractMwsObject {
    ...
    /** Value constructor. */
    public ListAllFulfillmentOrdersByNextTokenRequest(String sellerId,String nextToken) {
        this.sellerId = sellerId;
        this.nextToken = nextToken;
    }    
