...
public class ProfitShareSubtractionAdvertisingCostReportImpl implements ProfitShareSubtractionAdvertisingCostReport {
    private String dateStart;
    private String dateEnd;
    private String isurKcode;
    private String rcvrKcode;
    private BigDecimal total;
    private List<ProfitShareSubtractionAdvertisingCostReportLineItem> lineItems;
    ...
    public void setLineItems(List<ProfitShareSubtractionAdvertisingCostReportLineItem> lineItems) {
