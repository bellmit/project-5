...
<link href="<c:url value="/resources/css/bootstrap-example.css"/>"
	type="text/css" rel="stylesheet">
<link href="<c:url value="/resources/css/prettify.css"/>"
	type="text/css" rel="stylesheet">

<link href="<c:url value="/resources/css/awesome-bootstrap-checkbox.css"/>"
	type="text/css" rel="stylesheet">	
...
<script type='text/javascript'
	src="<c:url value="/resources/js/bootstrap-multiselect-collapsible-groups.js"/>"></script>
<script type='text/javascript'
							...
							function($scope, $http) {
								...
								$scope.saveDevelopingProduct = function(form) {
									...
									if(form.$invalid || $scope.BaseProductCodeExisting
										...
										$.ajax({
											url : "${pageContext.request.contextPath}/saveCoreProductInformation",
											type : 'POST',
											data : JSON.stringify(developingProduct),
											contentType : 'application/json',
											success : function(data) {
...
<div class="max-width" ng-app="developingProduct"
	ng-controller="developingProductCtrl">
		...
		<div class="row">
			<div class="col-md-12">
			    <c:choose>
					...
					<c:otherwise>											
					<div class="page-heading">${baseProductCode} ${productName}</div>
					...
					</button>																			<i class="far fa-check-square"></i>
		...
		<ul class="nav nav-tabs" role="tablist" style="margin-top:20px;">
    		...
    		<li role="presentation" class=" nav-item" ><a class="nav-link active" href="#home" aria-controls="home" role="tab"><spring:message code="detailsOfBaseProduct.productInformation" /></a></li>
    	<c:choose>
			<c:when test="${type ne 'Create'}">
     		<li role="presentation" class="nav-item" ><a class="nav-link" href="${pageContext.request.contextPath}/SourceProductMarketingMaterial/${baseProductCode}?supplierKcode={{supplierKcode}}"  role="tab"><spring:message code="detailsOfBaseProduct.productMarketingMaterial" /></a></li>
    		</c:when>
		</c:choose>	
  		</ul>
		...
		<div class="row rowframe">				
				<div class="col-md-8 offset-md-2">
					<div class="form-group">
						<label for="ApplicationSN"><spring:message code="productInfoSourceVersion.ApplicationSN" /></label>
						<select class="form-control width-600" name="applicationSN" ng-model="applicationSN">
					...
					<div class="form-group">
					<label for="supplierKcode"><spring:message code="productInfoSourceVersion.supplier" /><span class="text-danger"> *</span></label>
					<c:choose>
					...
					<div class="form-group">
					<label for=""><spring:message code="productInfoSourceVersion.productNameEn" /><span class="text-danger"> *</span></label>
					<input
					...
					<div class="form-group">
					<label for="productNameLocal"><spring:message code="productInfoSourceVersion.productNameLocal" /></label>
					<input
								class="form-control" id="productNameLocal" ng-model="productNameLocal"></td>
					</div>

					<div class="form-group">
					<label data-toggle="tooltip" data-placement="top" title="<spring:message code="productInfoSourceVersion.proposalProductCategory_hint" />"><spring:message code="productInfoSourceVersion.proposalProductCategory" /></label>
					<a target="_blank" href="<spring:message code="productInfoSourceVersion.proposalProductCategory_link" />"><i class="fas fa-info-circle fa-1x"></i></a>
					<select
					...
					<div class="form-group">
					<label for="brandEnglish"><spring:message code="productInfoSourceVersion.brandEnglish" /></label>
					<input id="brandEnglish" class="form-control" ng-model="brandEng">
					</div>

					<div class="form-group">
					<label for="brandLocal"><spring:message code="productInfoSourceVersion.brandlocal" /></label>
					<input class="form-control" ng-model="brand">
					</div>

					<div class="form-group">
					<label for="supplierBaseProductCode" data-toggle="tooltip" data-placement="top" data-html="true" title="<spring:message code="productInfoSourceVersion.supplierBaseProductCode_hint"/>"><spring:message code="productInfoSourceVersion.supplierBaseProductCode" /><span class="text-danger"> *</span></label>
					...
					<div class="form-group">
					<label for="baseProductCode"><spring:message code="productInfoSourceVersion.baseProductCode" /> <span class="text-danger">*</span></label>
					...
					<div class="form-group">
					<label for="mlt" data-toggle="tooltip" data-placement="top" title="<spring:message code="productInfoSourceVersion.manufacturerLeadTime_hint" />"><spring:message code="productInfoSourceVersion.manufacturerLeadTime" /></label>
					...
					<div class="form-group">
					<label for=""><spring:message code="productInfoSourceVersion.allergy" /></label><br>
					...
					<div class="form-group">
								 ...
								 <label for="allergyOther"><spring:message code="productInfoSourceVersion.allergyYesOtherName" /></label> <input
					...
					<div class="form-group">
					<label for=""><spring:message code="productInfoSourceVersion.materialAndPercentage" /></label>
					...
					<div class="form-group">
					<label data-toggle="tooltip" data-placement="top" title="<spring:message code="productInfoSourceVersion.productReferenceLink_hint" />"><spring:message code="productInfoSourceVersion.productReferenceLink" /></label>
					<div ng-repeat="referenceLinkLineItem in referenceLinkLineItems"
									style="padding-bottom: 10px">
									<div class="row">
										<div class="col-sm-12">
											<input class="form-control" style="display: inline;"
												ng-model="referenceLinkLineItem.referenceLink">									
											<button type="button" class="btn btn-default mt-1" ng-show="$index > 0"
												ng-click="removeReferenceLinkLineItem(referenceLinkLineItem)">
												<i class="fas fa-minus "></i>
											</button>
											<button type="button" class="btn btn-default mt-1" ng-hide="$index > 0"
			...
			<div id="variationTypes" class="col-md-12 m-3">
				...
				<label><spring:message code="productInfoSourceVersion.variationTypes" /></label>
				 <div class="form-check form-check-inline">
							<input
							...
							<label class="form-check-label" for="withVariation"></label>
							</div>
							...
							<input id="noVariation"
								...
								class="form-check-input" name="variationTypes"
								value="No" ng-click="checkVariationTypes()" ng-disabled="productLineItems.length > 0" ng-checked="productWithVariation=='0'">
								<label for="noVariation"></label>							
								</div>
							<label class="form-check-label"><spring:message code="productInfoSourceVersion.noVariation" /></label>
							<c:choose>
								<c:when test="${type eq 'Create'}"> 
							...
							<div class="text-danger" ng-show="variationTypeDuplicated">
			...
			<div id="productSection" class="row"
				...
				<div class="table-responsive">
					<table class="table">
						<thead>
							<tr>
								<th style="width: 10%;" ng-if="productWithVariation=='1'&&type1!=''">{{type1Column}}</th>
								<th style="width: 10%;" ng-if="productWithVariation=='1'&&type2!=''">{{type2Column}}</th>
								<th style="width: 15%;"><span data-toggle="tooltip" data-placement="top" data-html="true" title="<spring:message code="productInfoSourceVersion.SKUcode_hint" />"><spring:message code="productInfoSourceVersion.SKUcode" /></span></th>								
								<th style="width: 35%;"><span data-toggle="tooltip" data-placement="top" title="<spring:message code="productInfoSourceVersion.GTIN_hint" />"><spring:message code="productInfoSourceVersion.GTIN" /></span></th>		
								<th class="text-center"><span data-toggle="tooltip" data-placement="top" title="<spring:message code="productInfoSourceVersion.FCAPrice_hint" />"><spring:message code="productInfoSourceVersion.FCAPrice" /></span> <a target="_blank" href="<spring:message code="Joomla_root_link" />/fee/drs-cashflow-glossary#FCAprice"><i class="fas fa-info-circle"></i></a></th>						
								<th><spring:message code="productInfoSourceVersion.applicableRegion" /></th>
								<th ng-if="productWithVariation=='1'"><button type="button" class="btn btn-default"
						...
						<tbody>
							<tr ng-repeat="productLineItem in productLineItems">
								<td
									ng-if="productWithVariation=='1'&&type1!=''">
									<input class="form-control" style="width:90%;display: inline;" name="type1Value{{$id}}" ng-model="productLineItem.type1Value" ng-disabled="productLineItem.status=='edit' && formValidated == true" required>
								<span class="text-danger">*</span>
								<div class="text-danger" ng-show="productInfoSourceVersion.type1Value{{$id}}.$error.required && productInfoSourceVersion.type1Value{{$id}}.$dirty || (productLineItem.type1Value == '' && formValidated == false)">
								<spring:message code="productInfoSourceVersion.variationType_req" />
								</div>
								</td>
								<td
									ng-if="productWithVariation=='1'&&type2!=''"><input
									class="form-control" style="width:90%;display: inline;" name="type2Value{{$id}}" ng-model="productLineItem.type2Value" ng-disabled="productLineItem.status=='edit' && formValidated == true" required>
								<span class="text-danger">*</span>
								<div class="text-danger" ng-show="productInfoSourceVersion.type2Value{{$id}}.$error.required && productInfoSourceVersion.type2Value{{$id}}.$dirty || (productLineItem.type2Value == '' && formValidated == false)">
								<spring:message code="productInfoSourceVersion.variationType_req" />
								</div>
								</td>
								<td>
								<input
									class="form-control" style="width:90%;display: inline;" name="SKU{{$id}}" ng-model="productLineItem.SKU" ng-change="checkSKUValueDuplicated(productLineItem)" ng-disabled="productLineItem.status=='edit' && formValidated == true" ng-pattern="/^[a-zA-Z0-9\-]+$/" required>
								<span class="text-danger">*</span>	
								<div class="text-danger" ng-show="productInfoSourceVersion.SKU{{$id}}.$error.required && productInfoSourceVersion.SKU{{$id}}.$dirty || (productLineItem.SKU == '' && formValidated == false)">
									<spring:message code="productInfoSourceVersion.sku_req" />									
								</div>
								<div class="text-danger" ng-show="productInfoSourceVersion.SKU{{$id}}.$error.pattern">
								...
								<c:when test="${type eq 'Create'}">
								<input
									class="form-control" name="GTINValue{{$id}}" style="width: 140px; display: inline;"
								...
								<span class="form-check form-check-inline" style="padding-top:15px;">
								<input type="checkbox" class="form-control" name="GTINProvider" style="width: 5%; display: inline;" ng-model="productLineItem.providedByDRS" value="true"  id="SKU{{$id}}_GTINProvider"> <spring:message code="GTIN.providerDRS" />
								...
								<span class="form-check form-check-inline" style="padding-top:15px;">
								<input type="checkbox" class="form-control" name="GTINProvider" style="width: 5%; display: inline;margin:0px;" ng-model="productLineItem.providedByDRS" value="true"  id="SKU{{$id}}_GTINProvider">
								<label for="SKU{{$id}}_GTINProvider" > <spring:message code="GTIN.providerDRS" /></label>
								</span>	
								</sec:authorize>								
								...
								<td class="text-center"><input
									class="form-control" style="width: 60%; display: inline;" name="FCAPrice{{$id}}"
									ng-model="productLineItem.FCAPrice" ng-pattern="/^0*[1-9][0-9]*(\.[0-9]+)?|0+\.[0-9]*[1-9][0-9]*$/"> TWD
								<div class="text-danger" ng-show="productInfoSourceVersion.FCAPrice{{$id}}.$error.pattern">
									<spring:message code="productInfoSourceVersion.FCAPrice_format" />
								</div>	
								</td>																							
								<td class="text-center">
								 <span class="form-check form-check-inline" style="margin-left:10px;">
								...
								<td
									ng-if="productWithVariation=='1'">
									<span ng-if="productLineItem.status=='create'">
							...
							<tr ng-if="productWithVariation=='1'&& type2!=''">
								<td colspan=2></td>								
								<td>
								...
								<td>
								<div class="text-danger" ng-show="GTINValueDuplicated">									
			...
			<div class="row" id="sizeSection" class="row"
				...
				<div class="table-responsive">
					<table class="table">
						<thead>
							<tr>
								<th style="width: 15%;"><spring:message code="productInfoSourceVersion.variationProduct" /></th>
								<th style="width: 40%;"><span data-toggle="tooltip" data-placement="top" title="<spring:message code="productInfoSourceVersion.productDimension_hint" />"><spring:message code="productInfoSourceVersion.productDimension" /></span></th>
								<th style="width: 20%;"><span data-toggle="tooltip" data-placement="top" title="<spring:message code="productInfoSourceVersion.productWeight_hint" />"><spring:message code="productInfoSourceVersion.productWeight" /></span></th>
								<th></th>
							</tr>
						</thead>
						<tbody>
							<tr class="success">
								<td></td>
								<td><input
									id="packageDimension1ToApply" name="packageDimension1ToApply" ng-model="packageDimension1ToApply" class="form-control"
									style="width: 15%; display: inline;" ng-pattern="/^0*[1-9][0-9]*(\.[0-9]+)?|0+\.[0-9]*[1-9][0-9]*$/"> X <input
									id="packageDimension2ToApply" name="packageDimension2ToApply" ng-model="packageDimension2ToApply" class="form-control"
									style="width: 15%; display: inline;" ng-pattern="/^0*[1-9][0-9]*(\.[0-9]+)?|0+\.[0-9]*[1-9][0-9]*$/"> X <input
									id="packageDimension3ToApply" name="packageDimension3ToApply" ng-model="packageDimension3ToApply" class="form-control"
									style="width: 15%; display: inline;" ng-pattern="/^0*[1-9][0-9]*(\.[0-9]+)?|0+\.[0-9]*[1-9][0-9]*$/"> <select
								...
								<div class="text-danger" ng-show="productInfoSourceVersion.packageDimension1ToApply.$error.pattern || productInfoSourceVersion.packageDimension2ToApply.$error.pattern || productInfoSourceVersion.packageDimension3ToApply.$error.pattern">
								<spring:message code="productInfoSourceVersion.productDimension_format" />
								</div>
								</td>
								<td><input
									id="packageWeightToApply" name="packageWeightToApply" ng-model="packageWeightToApply" class="form-control"
									style="width: 25%; display: inline;" ng-pattern="/^0*[1-9][0-9]*(\.[0-9]+)?|0+\.[0-9]*[1-9][0-9]*$/"> <select
									id="packageWeightUnitToApply" class="form-control"
							...
							<tr ng-repeat="productLineItem in productLineItems">
								...
								<div class="text-danger" ng-show="productInfoSourceVersion.packageDimension1{{$id}}.$error.pattern || productInfoSourceVersion.packageDimension2{{$id}}.$error.pattern || productInfoSourceVersion.packageDimension3{{$id}}.$error.pattern">
								<spring:message code="productInfoSourceVersion.productDimension_format" />
								</div>
								</td>
								<td><input
									class="form-control" name="packageWeight{{$id}}" style="width: 25%; display: inline;"
								...
								<div class="text-danger" ng-show="productInfoSourceVersion.packageWeight{{$id}}.$error.pattern">
								<spring:message code="productInfoSourceVersion.productWeight_format" />
								</div>
								</td>
								<td></td>
        ...
        <div class="row rowframe">        		
				...
				<div class="form-group">
				<label for="originalPlace"> <spring:message code="productInfoSourceVersion.originalPlace" /> </label>
				<select
				...
				<div class="form-group">
				<label for="medicalDevice"><spring:message code="productInfoSourceVersion.medicalDevice" /></label>
				</br>
				<div class="form-check form-check-inline">
							<input id="medicalYes"
				...
				<div class="form-group">
				<label><spring:message code="productInfoSourceVersion.wirelessTechnology" /></label> </br>
				...
				<div class="form-group">
				<label><spring:message code="productInfoSourceVersion.otherWirelessTechnology" /></label>
				...
				<div class="form-group">
				<label data-toggle="tooltip" data-placement="top" title="<spring:message code="productInfoSourceVersion.hSCodeForSupplySideCountry_hint" />"><spring:message code="productInfoSourceVersion.hSCodeForSupplySideCountry" /></label> <a target="_blank" href="https://fbfh.trade.gov.tw/rich/text/indexfh.asp"><i class="fas fa-info-circle"></i></a>
				<input class="form-control" ng-model="hsCode">
				</div>

				<div class="form-group">
				<label><spring:message code="productInfoSourceVersion.documentationForSupplierSideCountry" /></label><br>
				...
				<div class="form-group">
				<label><spring:message code="productInfoSourceVersion.containMaterial" /></label><br>
				...
				<div class="form-group">
				<label> <spring:message code="productInfoSourceVersion.hazardousMaterials" /> </label>
					...
					<col style="width:55px;" />
						...
						<thead>
							<tr>
								...
								<th><span data-toggle="tooltip" data-placement="top" title="<spring:message code="productInfoSourceVersion.batteryType_hint" />"><spring:message code="productInfoSourceVersion.batteryType" /></span><span ng-if="batteryRequired" class="text-danger">*</span></th>
								<th><spring:message code="productInfoSourceVersion.rechargeable" /><span ng-if="batteryRequired" class="text-danger">*</span></th>
								<th><spring:message code="productInfoSourceVersion.batterySpecification" /><span ng-if="batteryRequired" class="text-danger">*</span></th>
								<th><spring:message code="productInfoSourceVersion.batteryFile" /><span ng-if="batteryRequired" class="text-danger">*</span></th>
								<th>SKU<span ng-if="batteryRequired" class="text-danger">*</span></th>
								<th><spring:message code="productInfoSourceVersion.lithiumBatteryPackingWay" /></th>
								<th><button type="button" id="addBattery" class="btn btn-default"
						...
						<tbody>
							<tr ng-repeat="batteryLineItem in batteryLineItems">
								...
								<div class="text-danger" ng-show="productInfoSourceVersion.batteryType{{$id}}.$error.required && productInfoSourceVersion.batteryType{{$id}}.$dirty || (batteryRequired == true  && batteryLineItem.batteryType == '' && formValidated == false)">
								...
								<input type="checkbox"
									class="" name="rechargeable" value="true" id="rechargable_{{$index+1}}"
									ng-model="batteryLineItem.rechargeable">
								<label for="rechargable_{{$index+1}}"></label>	
								</span>
								</td>

								<td style="vertical-align:top;" class="form-inline">
								<input style="width:160px;margin-bottom:5px;"
								...
								<div class="text-danger" ng-show="productInfoSourceVersion.cellsNumber{{$id}}.$error.required && productInfoSourceVersion.cellsNumber{{$id}}.$dirty || (batteryRequired == true  && batteryLineItem.cellsNumber == '' && formValidated == false)">
									<spring:message code="productInfoSourceVersion.cellsNumber_req" />
								</div>
								<div class="text-danger" ng-show="productInfoSourceVersion.cellsNumber{{$id}}.$error.pattern">	
								...
								<div class="text-danger" ng-show="productInfoSourceVersion.votage{{$id}}.$error.required && productInfoSourceVersion.votage{{$id}}.$dirty || (batteryRequired == true  && batteryLineItem.votage == '' && formValidated == false)">
									<spring:message code="productInfoSourceVersion.votage_req" />
								</div>
								<div class="text-danger" ng-show="productInfoSourceVersion.votage{{$id}}.$error.pattern">	
								...
								<div class="text-danger" ng-show="productInfoSourceVersion.capacity{{$id}}.$error.required && productInfoSourceVersion.capacity{{$id}}.$dirty || (batteryRequired == true  && batteryLineItem.capacity == '' && formValidated == false)">
									<spring:message code="productInfoSourceVersion.capacity_req" />
								</div>
								<div class="text-danger" ng-show="productInfoSourceVersion.capacity{{$id}}.$error.pattern">	
								...
								<div class="text-danger" ng-show="productInfoSourceVersion.weight{{$id}}.$error.required && productInfoSourceVersion.weight{{$id}}.$dirty || (batteryRequired == true  && batteryLineItem.weight == '' && formValidated == false)">
									<spring:message code="productInfoSourceVersion.weight_req" />
								</div>
								<div class="text-danger" ng-show="productInfoSourceVersion.weight{{$id}}.$error.pattern">	
								...
								<div id="BatteryFileUploadFail{{$index+1}}" class="text-danger"></div>
									...
									<div class="text-danger" style="float:left" ng-show="batteryRequired == true && batteryLineItem.batteryFileLineItems.length == 0 && formValidated == false">
							...
							<div class="row" >
							 <div class="col-md-12" ng-repeat="productLineItem in productLineItems">
									<div class="checkbox checkbox-success">
										<input type="checkbox" name="appliedVariationProduct[]" id="appliedVariationProduct_{{$id}}"
										...
										<label for="appliedVariationProduct_{{$id}}">
								...
								<div class="text-danger" ng-show="batteryRequired == true && batteryLineItem.appliedVariationProduct.length==0 && formValidated == false">
								...
								<td style="vertical-align:top;">
									...
									<div class="text-danger" ng-show="productInfoSourceVersion.packingWay{{$id}}.$error.required && productInfoSourceVersion.packingWay{{$id}}.$dirty || (batteryLineItem.isPackingWayRequired == true  && batteryLineItem.packingWay == '' && formValidated == false)">
					...
					<table class="table">	
						<thead>	
							<tr>
								...
								<th style="width:300px;"><span data-toggle="tooltip" data-placement="top" title="<spring:message code="productInfoSourceVersion.referenceFileName_hint" />"><spring:message code="productInfoSourceVersion.referenceFileName" /></span></th>
								<th style="width:220px;"><spring:message code="productInfoSourceVersion.referenceLink" /></th>
								<th style="width:220px;"><spring:message code="productInfoSourceVersion.referenceType" /><spring:message code="productInfoSourceVersion.slash" /><spring:message code="productInfoSourceVersion.applicableRegions" /></th>
								<th style="width:220px;"><spring:message code="productInfoSourceVersion.referenceLinkDescription" /></th>								
							<th style="width: 50px;">SKU</th>
							<th style="width: 50px;"><button type="button" id="addReferenceLink" class="btn btn-default"
						...
						<tbody>
							<tr ng-repeat="referenceFileLineItem in referenceFileLineItems" style="padding-bottom: 10px">
								...
								<td style="vertical-align:top;" colspan="2" class="form-inline">
