 ...
 *             &lt;element name="DefaultShipFromLocationAddress" type="{https://mws.amazonservices.com/Orders/2013-09-01}Address" minOccurs="0"/&gt;
 ...
 *             &lt;element name="FulfillmentInstruction" type="{https://mws.amazonservices.com/Orders/2013-09-01}FulfillmentInstruction" minOccurs="0"/&gt;
 *             &lt;element name="FulfillmentExecution" type="{https://mws.amazonservices.com/Orders/2013-09-01}FulfillmentExecution" minOccurs="0"/&gt;
 *             &lt;element name="IsISPU" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *          &lt;/sequence&gt;
 *       &lt;/restriction&gt;
 *    &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Order extends AbstractMwsObject {
    ...
    private FulfillmentExecution fulfillmentExecution;
    ...
    /**
     * Get the value of DefaultShipFromLocationAddress.
     *
     * @return The value of DefaultShipFromLocationAddress.
     */
    ...
    /**
     * Set the value of DefaultShipFromLocationAddress.
     *
     ...
     */
    public boolean isSetDefaultShipFromLocationAddress() {
        return defaultShipFromLocationAddress != null;
    }
    ...
    /**
     * Get the value of FulfillmentInstruction.
     *
     * @return The value of FulfillmentInstruction.
     */
    ...
    /**
     * Set the value of FulfillmentInstruction.
     *
     ...
     */
    public boolean isSetFulfillmentInstruction() {
        return fulfillmentInstruction != null;
    }
    ...
    /**
     * Get the value of FulfillmentExecution.
     *
     * @return The value of FulfillmentExecution.
     */
    public FulfillmentExecution getFulfillmentExecution() {
        return fulfillmentExecution;
    }

    /**
     * Set the value of FulfillmentExecution.
     *
     * @param fulfillmentExecution
     *            The new value to set.
     */
    public void setFulfillmentExecution(FulfillmentExecution fulfillmentExecution) {
        this.fulfillmentExecution = fulfillmentExecution;
    }
     ...
     */
    public boolean isSetFulfillmentExecution() {
        return fulfillmentExecution != null;
    }
    ...
    public boolean isIsISPU() {
        return isISPU!=null && isISPU.booleanValue();
    }

    /**
     * Get the value of IsISPU.
     *
     * @return The value of IsISPU.
     */
     ...
     * @return This instance.
     */
    public Order withIsISPU(Boolean isISPU) {
        this.isISPU = isISPU;
        return this;
    }
    ...
    public void readFragmentFrom(MwsReader r) {
        ...
        defaultShipFromLocationAddress = r.read("DefaultShipFromLocationAddress", Address.class);
        ...
        fulfillmentInstruction = r.read("FulfillmentInstruction", FulfillmentInstruction.class);
        fulfillmentExecution = r.read("FulfillmentExecution", FulfillmentExecution.class);
        isISPU = r.read("IsISPU", Boolean.class);
    }
    ...
    public void writeFragmentTo(MwsWriter w) {
        ...
        w.write("DefaultShipFromLocationAddress", defaultShipFromLocationAddress);
        ...
        w.write("FulfillmentInstruction", fulfillmentInstruction);
        w.write("FulfillmentExecution", fulfillmentExecution);
        w.write("IsISPU", isISPU);
    }
