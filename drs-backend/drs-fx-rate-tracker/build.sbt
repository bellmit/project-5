name :=  "drs-fx-rate-tracker"
mainClass in Compile := Some("com.kindminds.drs.fx.rate.App")
...
"org.hibernate" % "hibernate-core" % "5.4.1.Final",
  ...
  "com.kindminds.drs" % "drs-api" % "1.0.0-RELEASE",
  "com.kindminds.drs" % "drs-persist" % "1.0.0-RELEASE",
