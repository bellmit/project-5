...
import com.kindminds.drs.data.pipelines.api.message.{Command, RegisterCommandHandler, RegisterQueryHandler}
...
class DrsDPCmdBus() extends Actor {
...
class DrsDPQueryBus() extends Actor {
