...
<head>
<title>Amazon Inventory Health Report - DRS</title>
</head>
<div class="max-width">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="page-heading">
					Import Amazon Inventory Health Report
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6">
				<form method="POST" enctype="multipart/form-data" action="${pageContext.request.contextPath}/amazon-inventory-health-report/uploadAndImport">
					<table class="no-head">
						<tr>
			...
			<div class="col-md-6">
				<table class="table" style="padding:10px" >
					...
					<c:forEach items="${importStatuses}" var="importStatus">
						<tr>
							<td>${importStatus.marketplace.name}</td>
							<td>${importStatus.snapshotDate}</td>	
						</tr>
					</c:forEach>										
					</tbody>
				</table>								
