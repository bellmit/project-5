...
public class ProfitShareSubtractionMarketingActivityExpenseReportImpl implements ProfitShareSubtractionMarketingActivityExpenseReport {
    private String dateStart;
    private String dateEnd;
    private String isurKcode;
    private String rcvrKcode;
    private BigDecimal total;
    private List<ProfitShareSubtractionMarketingActivityExpenseReportLineItem> lineItems;
    ...
    public void setLineItems(List<ProfitShareSubtractionMarketingActivityExpenseReportLineItem> lineItems) {
