...
/**
 * <p>Java class for OptionalEnergyConsumptionUnitOfMeasure.
 * 
...
public enum OptionalEnergyConsumptionUnitOfMeasure {
    ...
    OptionalEnergyConsumptionUnitOfMeasure(String v) {
        value = v;
    }
    ...
    public static OptionalEnergyConsumptionUnitOfMeasure fromValue(String v) {
        for (OptionalEnergyConsumptionUnitOfMeasure c: OptionalEnergyConsumptionUnitOfMeasure.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
