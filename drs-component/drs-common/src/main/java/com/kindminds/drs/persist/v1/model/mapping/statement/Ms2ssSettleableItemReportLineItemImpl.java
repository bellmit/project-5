...
public class Ms2ssSettleableItemReportLineItemImpl implements Ms2ssSettleableItemReportLineItem{
	...
	public Ms2ssSettleableItemReportLineItemImpl(int id, String transactionTimeUtc, String sku, String skuName, String name, String description, String sourceName, String currency, BigDecimal amount) {
		this.id = id;
