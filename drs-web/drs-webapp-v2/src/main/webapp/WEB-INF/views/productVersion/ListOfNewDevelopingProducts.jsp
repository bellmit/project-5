					...
					<tbody>
						<tr ng-repeat="product in productList">
							...
							<td class="text-right main-td no-text">
								<a class="btn btn-default" href="${pageContext.request.contextPath}/CoreProductInformation/{{product.baseProduct}}"><spring:message code="detailsOfBaseProduct.productInformation" /></a>
