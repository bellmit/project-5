		...
		<div class="row">
			<div class="col-md-12">
				<p class="text-right">
					...
					:${otherRefundAndAllowance.dateStart} ~ ${otherRefundAndAllowance.dateEnd}<br>
				...
				<table class="table">
					...
					<tbody>
						<c:forEach items="${otherRefundAndAllowance.lineItems}" var="lineItem">
							<tr>
								<td class="text-center"><spring:message code="ss2spStatement.otherRefundAndAllowanceFromMarketSideToCustomer" /></td>
