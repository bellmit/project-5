...
<div class="max-width" ng-app="productInfoSourceView" ng-controller="productInfoSourceViewCtrl">
	<div id="mainContainer" class="container-fluid">
					...
					<tbody>
						<tr ng-repeat="productLineItem in productLineItems">
							...
							<td>
								...
								<span ng-if="status !='Finalized'"> {{productLineItem.SKU}}</span>
								<span ng-if="status =='Finalized'"><a href="${pageContext.request.contextPath}/SKUs/{{productLineItem.SKU}}">{{productLineItem.SKU}}</a></span>
	    ...
	    <!-- battery information --!>
		<div class="row" ng-hide="containedMaterial.indexOf('battery')==-1">
			<div class="col-md-12">
				<div class="page-heading">
		...
		<div class="row rowframe" ng-hide="containedMaterial.indexOf('battery')==-1">
			<div class="col-md-12">
				<table class="table">
					<colgroup>
