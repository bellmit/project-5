...
/**
 * <p>Java class for ComputerWirelessTypeValues.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="ComputerWirelessTypeValues"&gt;
 ...
 * 
 */
@XmlType(name = "ComputerWirelessTypeValues")
@XmlEnum
public enum ComputerWirelessTypeValues {
    ...
    ComputerWirelessTypeValues(String v) {
        value = v;
    }
    ...
    public static ComputerWirelessTypeValues fromValue(String v) {
        for (ComputerWirelessTypeValues c: ComputerWirelessTypeValues.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
