...
<head>
  <title>
    <c:choose>
      ...
      <c:otherwise>
        ...
        <spring:message code="ccc.name" /> - DRS
      </c:otherwise>
    </c:choose>
  </title>
  ...
  <style>
    ...
    /* Prevent text overflow and hide arrow sign */
    #example-multiple-optgroups + div .dropdown-toggle {
      overflow: hidden;
    }

    #example-multiple-optgroups + div .dropdown-toggle b {
      display: none;
    }
    ...
    /* Center datetimepicker elements */
    .timepicker {
      text-align: center;
    }
  ...
  <script>
    jQuery(window).on("load", function (e) {
      ...
      */
      ...
      const tzTpDateCreated = document.getElementById("tz-tp-datecreated");
      const tzPacDateCreated = document.getElementById("tz-pac-datecreated");
      /* New datepicker */
/*       tzTpDateCreated.addEventListener("click", () => {
        if (tzTpDateCreated.classList.contains("btn-secondary")) {
          if (tzPacDateCreated.classList.contains("btn-primary")) {
            $("#dateCreated").data("DateTimePicker").destroy();
            document.getElementById("dateCreated").value = "";
          }
          tzTpDateCreated.classList.remove("btn-secondary");
          tzTpDateCreated.classList.add("btn-primary");
          tzPacDateCreated.classList.remove("btn-primary");
          tzPacDateCreated.classList.add("btn-secondary"); */
          $("#dateCreated").datetimepicker({
            format: "YYYY-MM-DD HH:mm ZZ", // Originally'MM/DD/YYYY', changed to comply with DRS's date format
            icons: {
              time: "far fa-clock",
...
/*         }
      ...
      /* tzPacDateCreated.addEventListener("click", () => {
        if (tzPacDateCreated.classList.contains("btn-secondary")) {
          if (tzTpDateCreated.classList.contains("btn-primary")) {
            $("#dateCreated").data("DateTimePicker").destroy();
            document.getElementById("dateCreated").value = "";
          }
          tzPacDateCreated.classList.remove("btn-secondary");
          tzPacDateCreated.classList.add("btn-primary");
          tzTpDateCreated.classList.remove("btn-primary");
          tzTpDateCreated.classList.add("btn-secondary"); */
          $("#dateCreated").datetimepicker({
            format: "YYYY-MM-DD HH:mm ZZ", // Originally'MM/DD/YYYY', changed to comply with DRS's date format
            icons: {
              time: "far fa-clock",
          ...
          <div class="col-md-12">
            <!-- <div class="page-heading">
              <c:choose>
                ...
                <c:otherwise>
                  <spring:message code="ccc.edit" />:
                  <spring:message code="ccc.name" />
                  <c:url var="action" value="/CustomerCareCases/update"></c:url>
                </c:otherwise>
              </c:choose>
            </div> -->
            <span class="text-danger">
              <spring:message code='ccc.tempValidation' /></span>
          </div>
        </div>
        <form:form action="${action}" name="CustomerCareCase" class="form-horizontal text-left"
          modelAttribute="CustomerCareCase">
          ...
          <div class="row">
            <div class="col-sm-6">
              ...
              <c:choose>
                <c:when test="${type eq 'Edit'}">
                  <div class="form-group row">
                    <label for="caseId" class="col-sm-4 col-form-label">
                      <spring:message code="ccc.id" /></label>
                    <div class="col-sm-8">
              ...
              <div class="form-group row">
                <label for="caseType" class="col-sm-4 col-form-label">
                  <spring:message code="ccc.caseType" /><span class="text-danger">*</span></label>
                <div class="col-sm-8">
                  <c:choose>
                    <c:when test="${type eq 'Create'}">
                  ...
                  <form:select id="caseType" class="form-control" path="caseType" ng-model="caseType" required="required">
                    ...
                    <c:forEach items="${caseTypeList}" var="caseType">
                      <form:option value="${caseType}">
                        <spring:message code="ccc.${caseType}" />
                      </form:option>
                    </c:forEach>
                  </form:select>
                  <small class="text-danger form-text"
                    ng-show="CustomerCareCase.caseType.$error.required && CustomerCareCase.caseType.$dirty">
              ...
              <div class="form-group row">
                <label for="orderId" class="col-sm-4 col-form-label">
                  <spring:message code="ccc.orderId" /></label>
                <div class="col-sm-8">
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" id="orderIdYes" name="orderId" value="yes" type="radio"
                      ng-click="checkOrderId()">
                    <label class="form-check-label pl-1" for="inlineCheckbox1">
                      <spring:message code="ccc.orderIdYes" /></label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" id="orderIdNo" name="orderId" value="no" type="radio"
                      ng-click="checkOrderId()" checked>
                    <label class="form-check-label pl-1" for="inlineCheckbox2">
                      <spring:message code="ccc.orderIdNo" /></label>
                  </div>
                </div>
              </div>

              <div class="form-group row" ng-repeat="withOrderId in withOrderIds">
                <label for="marketplaceOrderId" class="col-sm-4 col-form-label">
                  <spring:message code="ccc.marketplaceOrderId" /><span class="text-danger">*</span></label>
                <div class="col-sm-8">
                  <form:input id="marketplaceOrderId" class="form-control" path="marketplaceOrderId"
                    ng-model="withOrderId.marketplaceOrderId" ng-change="geOrderInfo();" required="required" />
                  <small class="text-danger form-text"
                    ng-show="CustomerCareCase.marketplaceOrderId.$error.required && CustomerCareCase.marketplaceOrderId.$dirty">
              ...
              <div class="form-group row" ng-repeat="withOrderId in withOrderIds">
                <label for="marketplaceOrderDate" class="col-sm-4 col-form-label">
                  <spring:message code="ccc.orderDate" /><span class="text-danger">*</span></label>
                <div class="col-sm-8">
                  <form:input id="marketplaceOrderDate" class="form-control"
                    style="display:inline;cursor:default;background-color:white;" path="marketplaceOrderDate"
                    ng-model="withOrderId.marketplaceOrderDate" required="required" />
                  <small class="text-danger form-text"
                    ng-show="CustomerCareCase.marketplaceOrderDate.$error.required && CustomerCareCase.marketplaceOrderDate.$dirty">
                    <spring:message code='ccc.orderDate_req' />
                  </small>
                </div>
                <!-- <div class="btn-toolbar col-sm-2 justify-content-end">
                  <div class="btn-group-vertical">
                    <button type="button" id="tz-tp-marketplaceorderdate" class="btn btn-secondary btn-sm m-0 px-2">
                      Taipei
                    </button>
                    <button type="button" id="tz-pac-marketplaceorderdate" class="btn btn-secondary btn-sm m-0 px-2">
                      Pacific
                    </button>
                  </div>
                </div> -->
              ...
              <div class="form-group row" ng-repeat="withOrderId in withOrderIds">
                <label for="customerName" class="col-sm-4 col-form-label">
                  <spring:message code="ccc.customerName" /><span class="text-danger">*</span></label>
                <div class="col-sm-8">
                  <form:input id="customerName" class="form-control" path="customerName" ng-model="withOrderId.customerName"
                    required="required" />
                  <small class="text-danger form-text"
                    ng-show="CustomerCareCase.customerName.$error.required && CustomerCareCase.customerName.$dirty">
              ...
              <div class="form-group row" ng-repeat="withOrderId in withOrderIds">
                <label for="DRSCompany" class="col-sm-4 col-form-label">
                  <spring:message code="ccc.drsCompany" /><span class="text-danger">*</span></label>
                <div class="col-sm-8">
                  <form:input id="DRSCompany" class="form-control" path="drsCompanyKcode"
                    ng-model="withOrderId.drsCompanyKcode" required="required" readonly="true" />
                  <small class="text-danger form-text"
                    ng-show="CustomerCareCase.drsCompanyKcode.$error.required && CustomerCareCase.drsCompanyKcode.$dirty">
              ...
              <div class="form-group row" ng-repeat="noneOrderId in noneOrderIds">
                <label for="customerName" class="col-sm-4 col-form-label">
                  <spring:message code="ccc.customerName" /><span class="text-danger">*</span></label>
                <div class="col-sm-8">
                  <form:input id="customerName" class="form-control" path="customerName" ng-model="noneOrderId.customerName"
                    required="required" />
                  <small class="text-danger form-text"
                    ng-show="CustomerCareCase.customerName.$error.required && CustomerCareCase.customerName.$dirty">
                    <spring:message code='ccc.customerName_req' />
              ...
              <div class="form-group row" ng-repeat="noneOrderId in noneOrderIds">
                <label for="marketplace" class="col-sm-4 col-form-label">
                  <spring:message code="common.marketplace" /><span class="text-danger">*</span></label>
                <div class="col-sm-8">
                  <form:select id="marketplace" class="form-control" path="marketplace" ng-model="noneOrderId.marketplace"
                    ng-change="getDrsCompany()" required="required">
                    <form:option value="" label="--- Select ---" />
                  ...
                  <small class="text-danger form-text"
                    ng-show="CustomerCareCase.contactChannel.$error.required && CustomerCareCase.contactChannel.$dirty">
              ...
              <div class="form-group row" ng-repeat="noneOrderId in noneOrderIds">
                ...
                <div class="col-sm-8">
                  <form:input id="DRSCompany" class="form-control" path="drsCompanyKcode"
                    ng-model="noneOrderId.drsCompanyKcode" required="required" readonly="true" />
                  <small class="text-danger form-text"
                    ng-show="CustomerCareCase.drsCompanyKcode.$error.required && CustomerCareCase.drsCompanyKcode.$dirty">
                    <spring:message code='ccc.drsCompany_req' />
                  </small>
              ...
              <div class="form-group row">
                <label for="supplier" class="col-sm-4 col-form-label">
                  <spring:message code="ccc.supplier" /><span class="text-danger">*</span></label>
                <div class="col-sm-8">
                  <form:select id="supplier" class="form-control" path="supplierKcode" ng-model="supplier"
                  ...
                  <div class="text-danger"
                    ng-show="CustomerCareCase.supplierKcode.$error.required && CustomerCareCase.supplierKcode.$dirty">
              ...
              <div class="form-group row">
                <label for="relatedProduct-BP" class="col-sm-4 col-form-label">
                  <spring:message code="ccc.relatedProduct" /><span class="text-danger">*</span></label>
                <div class="col-sm-8">
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" name="relatedProduct" id="relatedProduct-BP" value="Base Product"
                      type="radio" ng-click="checkRelatedProduct()">
                    <label class="form-check-label pl-1" for="inlineCheckbox1">
                      <spring:message code="ccc.baseProduct" /></label>
                  </div>


                  <div class="form-check form-check-inline">
                    <input name="relatedProduct" class="form-check-input" id="relatedProduct-SKU" value="SKU" type="radio"
                      ng-click="checkRelatedProduct()" checked="TRUE">
                    <label class="form-check-label pl-1" for="inlineCheckbox1">
                      <spring:message code="ccc.sku" /></label>
                  </div>
                </div>
              </div>
              ...
              <div id="baseProduct" style="display: none;">
                <div ng-repeat="baseProductLineItem in baseProductLineItems">
                  <div class="form-group row d-flex align-items-center">
                    ...
                    <div class="col-sm-6">
                      <select name="baseProduct{{$index}}" id="baseProduct{{$index}}" class="form-control" ng-model="baseProductLineItem.baseProduct" ng-change="updateBaseProductList()" required>
                      </select>
                    ...
                    <div class="btn-toolbar col-sm-2 justify-content-end">
                      <div class="btn-group-vertical">
                        <button type="button" class="btn btn-secondary btn-sm m-0" ng-click="removeBaseProductLineItem(baseProductLineItem)">
                          <i class="fas fa-trash-alt"></i>
                        </button>
                        <button type="button" class="btn btn-secondary btn-sm m-0" ng-click="addBaseProductLineItem()">
                    ...
                    <!-- <div class="col-sm-6">
                      ...
                      <small class="text-danger form-text"
                        ng-show="CustomerCareCase.baseProduct{{$index}}.$error.required && CustomerCareCase.baseProduct{{$index}}.$dirty">
                        <spring:message code='ccc.baseProduct_req' />
                      </small>
                    </div>
              ...
              <div id="sku">
                <div ng-repeat="SKULineItem in SKULineItems">
                  <div class="form-group row d-flex align-items-center">
                    ...
                    <div class="col-sm-6">
                      <select name="sku{{$index}}" id="sku{{$index}}" class="form-control" ng-model="SKULineItem.sku"
                    ...
                    <div class="btn-toolbar col-sm-2 justify-content-end">
                      <div class="btn-group-vertical">
                        <button type="button" class="btn btn-secondary btn-sm m-0" ng-click="removeSKULineItem(SKULineItem)">
                          <i class="fas fa-trash-alt"></i>
                        </button>
                        <button type="button" class="btn btn-secondary btn-sm m-0" ng-click="addSKULineItem()">
                    ...
                    <!-- <div class="col-sm-6">
                      ...
                      <small class="text-danger form-text"
                        ng-show="CustomerCareCase.sku{{$index}}.$error.required && CustomerCareCase.sku{{$index}}.$dirty">
                        <spring:message code='ccc.sku_req' />
                      </small>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group row">
                <label for="issueTypeCategory" class="col-sm-4 col-form-label">
                  <spring:message code="ccc.issueCategory" /><span class="text-danger">*</span></label>
                <div class="col-sm-8">
                  <form:select id="issueTypeCategory" class="form-control" path="issueTypeCategoryId"
                    ng-model="issueTypeCategory" ng-change="getIssueTypeToIssues()" required="required">
                  ...
                  <small class="text-danger form-text"
                    ng-show="CustomerCareCase.issueTypeCategoryId.$error.required && CustomerCareCase.issueTypeCategoryId.$dirty">
              ...
              <!-- 議題 -->
              <div class="form-group row d-flex align-items-center">
                <label for="example-multiple-optgroups" class="col-sm-4 col-form-label">
                  <spring:message code="ccc.issue" /><span class="text-danger">*</span></label>
                <div class="col-sm-8">
                  <select id="example-multiple-optgroups" name="relatedIssueIds" multiple="multiple" ng-model="relatedIssueIds" required>
                  </select>
                  <div class="text-danger"
                    ng-show="CustomerCareCase.relatedIssueIds.$error.required && CustomerCareCase.relatedIssueIds.$dirty">
              ...
              <div class="form-group row d-flex flex-row align-items-center">
                <label for="dateCreated" class="col-sm-4 col-form-label">
                  <spring:message code="ccc.customerContactTime" /><span class="text-danger">*</span></label>
                <div class="col-sm-6">
                  <form:input id="dateCreated" class="form-control"
                    style="display:inline;cursor:default;background-color:white;" path="dateCreated" ng-model="dateCreated"
                    required="required" />
                  <small class="text-danger form-text"
                    ng-show="CustomerCareCase.dateCreated.$error.required && CustomerCareCase.dateCreated.$dirty">
                    <spring:message code='ccc.customerContactTime_req' />
                  </small>
                </div>
                <div class="btn-toolbar col-sm-2 justify-content-end">
                  <div class="btn-group-vertical">
                    <button type="button" id="tz-tp-datecreated" class="btn btn-secondary btn-sm m-0 px-2">
                      Taipei
                    </button>
                    <button type="button" id="tz-pac-datecreated" class="btn btn-secondary btn-sm m-0 px-2">
                      Pacific
                    </button>
                  </div>
                </div>
              ...
              <div class="form-group row">
                <label for="status" class="col-sm-4 col-form-label">
                  <spring:message code="ccc.status" /></label>
                <div class="col-sm-8">
                  <form:select id="status" class="form-control" path="status">
                    <form:option value="processing">
                      <spring:message code="ccc.processing" />
                    </form:option>
                    <form:option value="waitingForCustomerResponse">
                      <spring:message code="ccc.waitingForCustomerResponse" />
                    </form:option>
                    <form:option value="caseClosed">
                      <spring:message code="ccc.caseClosed" />
                    </form:option>
                  </form:select>
                </div>
              </div>
          ...
          <div class="row mt-3">
            <div class="col-md-12" style="height: 250px;">
              <label class="my-3">
                <spring:message code="ccc.origMsg" /><span class="text-danger">*</span></label>
              <c:forEach items="${CustomerCareCase.messages}" varStatus="message">
                <c:if test="${message.last}">
                  <form:textarea id="originalMessageFromCustomer${message.index}" class="form-control mh-100 px-2 py-1"
                    path="message[${message.index}].contents" rows="6" ng-model="message" required="required" />
                  <form:hidden path="message[${message.index}].lineSeq" />
                  <div class="text-danger"
                    ng-show="CustomerCareCase['message[${message.index}].contents'].$error.required && CustomerCareCase['message[${message.index}].contents'].$dirty">
          ...
          <div class="row">
            <div class="col-md-12 text-right">
              <input class="btn btn-primary" type="submit" value="<spring:message code='ccc.submit' />"
                ng-disabled="CustomerCareCase.$invalid" />
              <c:choose>
                <c:when test="${type eq 'Edit'}">
                  <a class="btn btn-link"
                    href="${pageContext.request.contextPath}/CustomerCareCases/${CustomerCareCase.caseId}">
