...
public class NewManageProductAndP2mApplicationToMongoEtlByBpCode {
...
//            String kcode = allCompanyKcodeList.get(a);
        ...
        for (int a = 0; a < getAllBaseProducts.size(); a++) {
            ...
            if(baseCode.equals("BP-K101-K423-2")){
            ...
            try {
                ...
                */
                ...
                System.out.println(docP.toJson());
                ...
                for(Object x :p2mAppliedSkuData){
                    ...
                    retailPrice = sku.getString("FCAPrice");
                ...
                for (int l = 0; l < index; l++) {
                    ...
                    for (int m = 0; m < perProductSKUIndex; m++) {
                        for (int n = 0; n < perSKUCountryIndex; n++) {
                            ...
                            if (perProductSKU[m].equals(perSKUCountry[n])) {
                                ...
                                appliedProductAdvancedInfoSKU = appliedProductAdvancedInfoSKU + perProductAdvancedInfoSku[m];
                    ...
                    try {
                        ...
                        try{
                            System.out.println(saveProductJson);
