...
/**
 * <p>Java class for OrganizationTaxRoles.
 * 
 ...
 * 
 */
@XmlType(name = "OrganizationTaxRoles")
@XmlEnum
public enum OrganizationTaxRoles {
    ...
    public static OrganizationTaxRoles fromValue(String v) {
        for (OrganizationTaxRoles c: OrganizationTaxRoles.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
