...
<div class="max-width">
	<div class="container-fluid" ng-app="issue" ng-controller="issueCtrl">
		...
		<form:form action="${action}" name="Issue"
			class="form-horizontal text-left" modelAttribute="Issue">
			<div class="row">
				<div class="col-md-6">

					<div class="form-group row">
						<label class="col-sm-4 col-form-label"><spring:message
								code="issue.issueCategory" /><span class="text-danger">*</span></label>
						<div class="col-sm-8">
							<form:hidden path="id" />
							<form:select id="categoryName" class="form-control"
								path="categoryId" ng-model="categoryName"
					...
					<div class="form-group row">
						<label class="col-sm-4 col-form-label"> <spring:message
								code="issue.issueType" /><span class="text-danger">*</span>
						</label>
						<div class="col-sm-8">
							<form:select id="issueType" class="form-control" path="typeId"
					...
					<div ng-repeat="issueNameLineItem in issueNameLineItems">
						<div class="form-group row">
							<label class="col-sm-4 col-form-label"><spring:message
									code="issue.issueName" /><span class="text-danger">*</span></label>
							...
							<div class="col-sm-3">
								...
								<small class="text-danger"
									...
									ng-show="Issue.issueName{{$index}}.$error.maxlength"> <spring:message
										code='issue.issueName_length' />
								</small>
							</div>
					...
					<div class="form-group row">
						<label class="col-sm-4 col-form-label"><spring:message
								code="issue.status" /><span class="text-danger">*</span></label>
						<div class="col-sm-8">
				...
				<div class="col-md-6">
					...
					<div class="form-group row">
						...
						<c:choose>
							<c:when test="${type eq 'Create'}">
								...
								<label class="col-sm-4 col-form-label"><spring:message
										code="issue.supplier" /><span class="text-danger">*</span></label>

								<div class="col-sm-8">
									<form:select id="supplier" class="form-control"
										style="display: inline;" path="supplierKcode"
										ng-model="supplier" ng-change="getRelatedProductList()">
										<form:option value="" label="Any" />
										<c:forEach var="supplier"
											items="${supplierKcodeToShortEnUsNameMap}">
											<form:option value="${supplier.key}"
												label="${supplier.key} ${supplier.value}" />
										</c:forEach>
									</form:select>
								</div>
							</c:when>
							<c:otherwise>
								...
								<label class="col-sm-4 col-form-label"><spring:message
										code="issue.supplier" /></label>


								<div class="col-sm-8">
									<c:choose>
										<c:when test="${!empty Issue.supplierKcode}">
								${Issue.supplierKcode} ${supplierKcodeToShortEnUsNameMap[Issue.supplierKcode]} <form:hidden
												id="supplier" path="supplierKcode" />
										</c:when>
										<c:otherwise>
					...
					<div class="form-group row" id="relatedProductTitle"
						ng-show="supplier !=''">
						<label class="col-sm-4 col-form-label"><spring:message
								code="issue.relatedProducts" /><span class="text-danger">*</span></label>
						<div class="col-sm-8">
							...
							<div ng-show="relatedProductType"
								...
								<input name="relatedProduct" id="relatedProduct-BP"
									...
									ng-click="checkRelatedProduct()"> <label
									class="form-check-label" for="relatedProduct-BP"><spring:message
										code="issue.baseProduct" /></label>
							</div>
							...
							<div ng-show="relatedProductType"
								...
								<label class="form-check-label" for="relatedProduct-SKU"><spring:message
										code="issue.sku" /></label>
							</div>
						...
						<div id="baseProduct" style="display: none;">
							...
							<div class="form-row">
								...
								<div class="col-sm-8 pl-3">
									...
									<form:hidden id="relatedProductBaseCodeList"
										path="relatedProductBaseCodeList" />
								</div>
							</div>
						</div>
						...
						<div id="sku">
							...
							<div class="form-row">
								...
								<div class="col-sm-8 pl-3">
									...
									<form:hidden id="relatedProductSkuCodeList"
										path="relatedProductSkuCodeList" />
								</div>
							</div>
						</div>
					</div>
					<c:if test="${type eq 'Edit'}">
						<div class="form-group row">
							<label class="col-sm-4 col-form-label"><spring:message
									code="issue.templateOccurrences" /></label>
							<div class="col-sm-8">${Issue.templateOccurrences}</div>

							<div class="form-group row">
								<label class="col-sm-4 col-form-label"><spring:message
										code="issue.created" /></label>
	...
	<div class="row">
		<div class="col-md-12 text-right">
			...
			<c:choose>
				<c:when test="${type eq 'Create'}">
					<a href="${pageContext.request.contextPath}/Issues"> <input
