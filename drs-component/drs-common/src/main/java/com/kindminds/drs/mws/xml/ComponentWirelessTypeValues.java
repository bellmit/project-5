...
/**
 * <p>Java class for ComponentWirelessTypeValues.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="ComponentWirelessTypeValues"&gt;
 ...
 * 
 */
@XmlType(name = "ComponentWirelessTypeValues")
@XmlEnum
public enum ComponentWirelessTypeValues {
    ...
    ComponentWirelessTypeValues(String v) {
        value = v;
    }
    ...
    public static ComponentWirelessTypeValues fromValue(String v) {
        for (ComponentWirelessTypeValues c: ComponentWirelessTypeValues.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
