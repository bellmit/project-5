...
public class FulfillmentOrder extends AbstractMwsObject {
    ...
    /** Value constructor. */
    public FulfillmentOrder(String sellerFulfillmentOrderId,String displayableOrderId,XMLGregorianCalendar displayableOrderDateTime,String displayableOrderComment,String shippingSpeedCategory,Address destinationAddress,XMLGregorianCalendar receivedDateTime,String fulfillmentOrderStatus,XMLGregorianCalendar statusUpdatedDateTime) {
        this.sellerFulfillmentOrderId = sellerFulfillmentOrderId;
        this.displayableOrderId = displayableOrderId;
        this.displayableOrderDateTime = displayableOrderDateTime;
        this.displayableOrderComment = displayableOrderComment;
