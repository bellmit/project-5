 ...
 *             &lt;element name="RentalTaxWithheldList" type="{http://mws.amazonservices.com/Finances/2015-05-01}TaxWithheldComponent" maxOccurs="unbounded"/&gt;
 *          &lt;/sequence&gt;
 *       &lt;/restriction&gt;
 *    &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class RentalTransactionEvent extends AbstractMwsObject {
    ...
    /**
     * Get the value of RentalTaxWithheldList.
     *
     * @return The value of RentalTaxWithheldList.
     */
    public List<TaxWithheldComponent> getRentalTaxWithheldList() {
        if (rentalTaxWithheldList==null) {
            rentalTaxWithheldList = new ArrayList<TaxWithheldComponent>();
        }
        return rentalTaxWithheldList;
    }

    /**
     * Set the value of RentalTaxWithheldList.
     *
    ...
    public boolean isSetRentalTaxWithheldList() {
        return rentalTaxWithheldList != null && !rentalTaxWithheldList.isEmpty();
    }
     ...
     * @return This instance.
     */
    public RentalTransactionEvent withRentalTaxWithheldList(TaxWithheldComponent... values) {
        List<TaxWithheldComponent> list = getRentalTaxWithheldList();
    ...
    public void readFragmentFrom(MwsReader r) {
        ...
        rentalTaxWithheldList = r.readList("RentalTaxWithheldList", "TaxWithheldComponent", TaxWithheldComponent.class);
    }
    ...
    public void writeFragmentTo(MwsWriter w) {
        ...
        w.writeList("RentalTaxWithheldList", "TaxWithheldComponent", rentalTaxWithheldList);
    }
