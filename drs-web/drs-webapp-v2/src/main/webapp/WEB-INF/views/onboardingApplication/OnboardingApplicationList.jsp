				...
				<table id="product-list-table" class="table table-hover" datatable="ng" dt-options="dtOptions" dt-instance="dtInstance" style="width:100%">
					...
					<tbody>
						<tr ng-repeat="product in productList">
							...
							<td class="main-td" id="base_product">{{product.serialNumber}}</td>	
							<td class="main-td">zzz</td>
							<td class="text-right main-td no-text">
								<a class="btn btn-default" href="${pageContext.request.contextPath}/ri"><spring:message code="detailsOfBaseProduct.productInformation" /></a>										
								<a class="btn btn-default" href="${pageContext.request.contextPath}/pmmi/{{product.baseProduct}}?supplierKcode={{product.supplierKcode}}"><spring:message code="detailsOfBaseProduct.productMarketingMaterial" /></a>
							</td>
						</tr>
					</tbody>
				</table>
