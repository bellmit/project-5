...
public final class SaveECReportToHDFS implements AutoProcessECReport {
    ...
    public SaveECReportToHDFS( Integer marketPlaceId, LocalDate scheduledDate, Integer reportType, Boolean success) {
    ...
    public final SaveECReportToHDFS copy( Integer marketPlaceId, LocalDate scheduledDate, Integer reportType, Boolean success) {
        return new SaveECReportToHDFS(marketPlaceId, scheduledDate, reportType, success);
    }

    // $FF: synthetic method
    public static SaveECReportToHDFS copy$default(SaveECReportToHDFS var0, Integer var1, LocalDate var2, Integer var3, Boolean var4, int var5, Object var6) {
        if ((var5 & 1) != 0) {
    ...
    public String toString() {
        return "SaveECReportToHDFS(marketPlaceId=" + this.getMarketPlaceId() + ", scheduledDate=" + this.getScheduledDate() + ", reportType=" + this.getReportType() + ", success=" + this.getSuccess() + ")";
    }
    ...
    public boolean equals( Object var1) {
        if (this != var1) {
            if (var1 instanceof SaveECReportToHDFS) {
                SaveECReportToHDFS var2 = (SaveECReportToHDFS)var1;
              /*
