 ...
 *             &lt;element name="RetrochargeTaxWithheldList" type="{http://mws.amazonservices.com/Finances/2015-05-01}TaxWithheldComponent" maxOccurs="unbounded"/&gt;
 *          &lt;/sequence&gt;
 *       &lt;/restriction&gt;
 *    &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class RetrochargeEvent extends AbstractMwsObject {
    ...
    /**
     * Get the value of RetrochargeTaxWithheldList.
     *
     * @return The value of RetrochargeTaxWithheldList.
     */
    public List<TaxWithheldComponent> getRetrochargeTaxWithheldList() {
        if (retrochargeTaxWithheldList==null) {
            retrochargeTaxWithheldList = new ArrayList<TaxWithheldComponent>();
        }
        return retrochargeTaxWithheldList;
    }

    /**
     * Set the value of RetrochargeTaxWithheldList.
     *
    ...
    public boolean isSetRetrochargeTaxWithheldList() {
        return retrochargeTaxWithheldList != null && !retrochargeTaxWithheldList.isEmpty();
    }
     ...
     * @return This instance.
     */
    public RetrochargeEvent withRetrochargeTaxWithheldList(TaxWithheldComponent... values) {
        List<TaxWithheldComponent> list = getRetrochargeTaxWithheldList();
        for (TaxWithheldComponent value : values) {
            list.add(value);
        }
        return this;
    }
    ...
    public void readFragmentFrom(MwsReader r) {
        ...
        retrochargeTaxWithheldList = r.readList("RetrochargeTaxWithheldList", "TaxWithheldComponent", TaxWithheldComponent.class);
    }
    ...
    public void writeFragmentTo(MwsWriter w) {
        ...
        w.writeList("RetrochargeTaxWithheldList", "TaxWithheldComponent", retrochargeTaxWithheldList);
    }
