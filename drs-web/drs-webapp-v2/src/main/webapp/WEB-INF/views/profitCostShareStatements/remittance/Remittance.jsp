...
<script>
	$(document).ready(function() {
		...
		$('#dateSent,#dateReceived').attr('readonly', true);
			...
			<form:form action="${action}" name="Remittance" modelAttribute="Remittance" novalidate="novalidate">
				<table class="table table-withoutBorder table-autoWidth table-centered">
					...
					<tr>
						...
						<td>
							<form:input id="amount" class="form-control" style="width:95%;display: inline;" path="amount" ng-model="amount" ng-pattern="/^0*[1-9][0-9]*(\.[0-9]+)?|0+\.[0-9]*[1-9][0-9]*$/" required="required"/>
							<span class="text-danger">*</span>
					...
					<tr>
						...
						<td>
							<form:input id="reference" class="form-control" style="width:95%;display: inline;" path ="reference" />
						</td>						
					</tr>
					<tr>
						<td colspan="2">
