 ...
 *             &lt;element name="ItemTaxWithheldList" type="{http://mws.amazonservices.com/Finances/2015-05-01}TaxWithheldComponent" maxOccurs="unbounded"/&gt;
...
public class ShipmentItem extends AbstractMwsObject {
    ...
    /**
     * Get the value of ItemTaxWithheldList.
     *
     * @return The value of ItemTaxWithheldList.
     */
    public List<TaxWithheldComponent> getItemTaxWithheldList() {
        if (itemTaxWithheldList==null) {
            itemTaxWithheldList = new ArrayList<TaxWithheldComponent>();
        }
        return itemTaxWithheldList;
    }

    /**
     * Set the value of ItemTaxWithheldList.
     *
    ...
    public boolean isSetItemTaxWithheldList() {
        return itemTaxWithheldList != null && !itemTaxWithheldList.isEmpty();
    }
     ...
     * @return This instance.
     */
    public ShipmentItem withItemTaxWithheldList(TaxWithheldComponent... values) {
        List<TaxWithheldComponent> list = getItemTaxWithheldList();
    ...
    public void readFragmentFrom(MwsReader r) {
        ...
        itemTaxWithheldList = r.readList("ItemTaxWithheldList", "TaxWithheldComponent", TaxWithheldComponent.class);
    ...
    public void writeFragmentTo(MwsWriter w) {
        ...
        w.writeList("ItemTaxWithheldList", "TaxWithheldComponent", itemTaxWithheldList);
