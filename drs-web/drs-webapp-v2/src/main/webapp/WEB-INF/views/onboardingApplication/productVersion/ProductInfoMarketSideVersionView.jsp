    ...
    <div class="col-md-12 max-width">
    	<div class="breadcrumb">
        	<sec:authorize access="hasAnyRole('${auth['PRODUCT_ONBOARDING_SUPPLIER']}')">
        		...
        		<span><spring:message code="detailsOfBaseProduct.productInformation" /> @<spring:message code="${marketSideRegion}" /></span>
        	</sec:authorize>
...
<div class="max-width" ng-app="productInfoMarketSideView" ng-controller="productInfoMarketSideViewCtrl">
	<div class="container-fluid">	
		...
		<div class="row">		
			<div class="col-md-12">
				<table class="table table-withoutBorder" style="width:350px">
					<tr>
						<td class="text-right">
