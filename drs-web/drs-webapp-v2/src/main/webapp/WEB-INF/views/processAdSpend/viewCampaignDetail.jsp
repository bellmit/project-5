...
<title><spring:message code='processAdSpend.viewCampaignDetail' /></title>
	            ...
	            callback: function(response, pagination){
	                ...
	                $.each(response, function(index, transaction){
	                    dataHtml += '<tr>\
	                     ...
	                     <td>'+ transaction.advertisedSku +'</td>\
	                     <td>'+ transaction.sku +'</td>\
	                     <td>'+ transaction.bp +'</td>\
	                     <td>'+ transaction.periodStartUtc +'</td>\
	                     <td>'+ transaction.periodEndUtc +'</td>\
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12" style="padding-left: 0px;">
				<div class="page-heading" style="font-weight: bold;">
				...
				<table class="table table-bordered">
					<thead>
						<tr class="success">
							...
							<th><spring:message code='processAdSpend.advertisedSKU' /></th>
							<th><spring:message code='processAdSpend.sku' /></th>
							<th><spring:message code='processAdSpend.bp' /></th>
							<th><spring:message code='processAdSpend.startDate' /></th>
							<th><spring:message code='processAdSpend.endDate' /></th>
